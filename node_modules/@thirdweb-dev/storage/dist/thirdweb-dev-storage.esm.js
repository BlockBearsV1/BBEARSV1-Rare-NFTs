...
const DEFAULT_GATEWAY_URLS = {
  ...
  "ipfs://": ["https://{cid}.gateway.ipfscdn.io/{path}", "https://{cid}.ipfs.twipfs.com/{path}", "https://{cid}.ipfs.twgateway.com/{path}", "https://{cid}.ipfs.thirdwebstorage.com/{path}", "https://{cid}.ipfs.thirdwebipfs.com/{path}", "https://{cid}.ipfs.thirdwebgateway.com/{path}", "https://{cid}.ipfs-public.thirdwebcdn.com/{path}", "https://cloudflare-ipfs.com/ipfs/{cid}/{path}", "https://ipfs.io/ipfs/{cid}/{path}"]
};
...
export { DEFAULT_GATEWAY_URLS, IpfsUploader, MockDownloader, MockUploader, PINATA_IPFS_URL, StorageDownloader, TW_IPFS_SERVER_URL, ThirdwebStorage, convertCidToV1, extractObjectFiles, getCID, getCIDForUpload, getGatewayUrlForCid, isBrowser, isBufferInstance, isBufferOrStringWithName, isFileBufferOrStringEqual, isFileInstance, isFileOrBuffer, isUploaded, parseGatewayUrls, prepareGatewayUrls, replaceGatewayUrlWithScheme, replaceObjectFilesWithUris, replaceObjectGatewayUrlsWithSchemes, replaceObjectSchemesWithGatewayUrls, replaceSchemeWithGatewayUrl };
